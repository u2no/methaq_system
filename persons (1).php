...
/* حذف شخص (يُنفَّذ قبل أي إخراج HTML حتى تعمل إعادة التوجيه بشكل صحيح) */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'delete') {
    ...
    if ($deleteId > 0) {
        ...
        $historyStmt = $pdo->prepare("SELECT COUNT(*) FROM custody WHERE person_id = :id");
        $historyStmt->execute([':id' => $deleteId]);
        $hasHistory = (int) $historyStmt->fetchColumn() > 0;

        if ($hasHistory) {

            $deleteError = 'لا يمكن حذف هذا الشخص لأن لديه سجل عهدة سابق أو حالي. يجب الاحتفاظ بالسجل التاريخي.';
            ...
            header('Location: persons.php?deleted=1');
            exit;
    ...
    <div class="table-card">
        ...
        <div class="table-tools">
            ...
            <form method="GET" action="" class="filter-form">
                ...
                <a href="persons.php" class="reset-btn">إعادة تعيين</a>
                            ...
                            <td>
                                ...
                                <div class="row-actions">
                                    ...
                                    <form
                                        ...
                                        action=""
                                        class="delete-form"
                                        onsubmit="return confirm('هل أنت متأكدة من حذف هذا الشخص؟ لا يمكن التراجع عن هذا الإجراء.');"
                                    >
